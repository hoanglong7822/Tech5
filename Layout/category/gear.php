<?php
	...
	$query = "SELECT * FROM `product` WHERE `product_type_id` = 5
		ORDER BY $sortName $sortBy LIMIT $begin, 20";
	$gear = mysqli_query($conn, $query);	
?>
<style>
/*product*/
	.product{
			...
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-md-10" >
						...
						<!--Sortby-->
						<?php
							while ($rows = mysqli_fetch_array($gear)) {
						?>
						<!-- product -->
						<div class="col-md-3">
							<div class="product">
						...
						<?php
							$sql_trang = mysqli_query($conn,"SELECT * FROM product WHERE product.product_type_id=5");
						...
						<ul class="list_trang">
							...
							?>
								<li>
									<a href="index.php?nav=gear&sort=<?php echo $sort ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
								</li>
							<?php 
									}
								}
							...
							?>
								<li>
									<a href="index.php?nav=gear&&page=<?php echo $i ?>"><?php echo $i ?></a>
								</li>
							<?php
									}
								}
