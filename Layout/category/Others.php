<?php
	...
	$query = "SELECT * FROM `product` WHERE `product_type_id` = 6
			...
			<div class="col-md-12">
				<div class="row">
											...
											<div class="card-body"> 
 												<ul>
													...
													<li>
													 <label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="1"> LG</label>
													</label>
													<label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="2"> JBL</label>
													</label>				
													</li>
													<li>
													 <label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="1"> Logitech</label>
													</label>
													<label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="2"> Sony</label>
													</label>				
													</li>			
												</ul>
											</div>
					...
					<div class="col-md-10" >
						...
						<!--Sortby-->
						<?php
							while ($rows = mysqli_fetch_array($other)) {
						?>
						<!-- product -->
						<div class="col-md-3">
							<div class="product">
						...
						<!--/PHANTRANG-->
						<?php
							$sql_trang = mysqli_query($conn,"SELECT * FROM product WHERE product.product_type_id=6");
						...
						<ul class="list_trang">
							...
							?>
								<li>
									<a href="index.php?nav=other&sort=<?php echo $sort ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
								</li>
							<?php 
									}
								}
							...
							?>
								<li>
									<a href="index.php?nav=other&&page=<?php echo $i ?>"><?php echo $i ?></a>
								</li>
							<?php
									}
								}
