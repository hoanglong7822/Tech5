<?php
	...
	$query = "SELECT * FROM `product` WHERE `product_type_id` = 3
		ORDER BY $sortName $sortBy LIMIT $begin, 20";
	$pc = mysqli_query($conn, $query);	
?>
<style>
/*product*/
	.product{
			...
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-md-10" >
						...
						<?php
							$sql_trang = mysqli_query($conn,"SELECT * FROM product WHERE product.product_type_id=3");
						...
						<ul class="list_trang">
							...
							?>
								<li>
									<a href="index.php?nav=pc&sort=<?php echo $sort ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
								</li>
							<?php 
									}
								}
							...
							?>
								<li>
									<a href="index.php?nav=pc&&page=<?php echo $i ?>"><?php echo $i ?></a>
								</li>
							<?php
									}
								}
