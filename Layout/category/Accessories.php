<?php
	...
	$query = "SELECT * FROM `product` WHERE `product_type_id` = 4
		ORDER BY $sortName $sortBy LIMIT $begin, 20";
	$accessories = mysqli_query($conn, $query);	
?>
<style>
/*product*/
	.product{
			...
			<div class="col-md-12">
				<div class="row">
										...
										<article class="filter-group">
											...
											<div class="card-body"> 
 												<ul>
													...
													<label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="2"> Cooler Master</label>
													</label>				
													</li>	
													<li>
													 <label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="1"> AMD</label>
													</label>
													<label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="2"> Intel</label>
													</label>				
													</li>
													<li>
													 <label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="1"> Kingston</label>
													</label>
													<label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="2"> Xingmatek</label>
													</label>				
													</li>
													<li>
													 <label class="ahihi">
													 	<input type="checkbox" id="" name="" value="">
  														<label for="1"> MSI</label>
													</label>				
													</li>		
												</ul>
											</div>
					...
					<div class="col-md-10" >
						...
						<!--Sortby-->
						<?php
							while ($rows = mysqli_fetch_array($accessories)) {
						?>
						<!-- product -->
						<div class="col-md-3">
							<div class="product">
						...
						<?php
							$sql_trang = mysqli_query($conn,"SELECT * FROM product WHERE product.product_type_id=4");
						...
						<ul class="list_trang">
							...
							?>
								<li>
									<a href="index.php?nav=accessories&sort=<?php echo $sort ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
								</li>
							<?php 
									}
								}
							...
							?>
								<li>
									<a href="index.php?nav=accessories&&page=<?php echo $i ?>"><?php echo $i ?></a>
								</li>
							<?php
									}
								}
